...
<li><p>Try <code>--vo=vaapi</code>. Although this is Intel’s native video output method, it seems to fix tearing only very rarely.</p></li>
...
mpv went on, radically minimizing its code base, as seen here: [[https://0x0.st/Lyl.png]]
